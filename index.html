...
<html lang="fr">
<head>
	<title>Azerty - Plateformes de freelance et de mise en relation avec les entreprises</title>

	<!-- Meta Tags -->
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<meta name="description" content="Azerty - Plateformes de freelance et de mise en relation avec les entreprises">
	...
	<script src="https://kit.fontawesome.com/cf1b6bc820.js" crossorigin="anonymous"></script>
	<link rel="stylesheet" type="text/css" href="assets/vendor/tiny-slider.css">
	<link rel="stylesheet" type="text/css" href="assets/vendor/glightbox.css">
		...
		<div class="container-fluid px-3 px-xl-5">
			...
			<div class="navbar-collapse w-100 collapse" id="navbarCollapse">
				...
				<ul class="navbar-nav navbar-nav-scroll me-auto">
					...
					<li class="nav-item dropdown dropdown-menu-shadow-stacked">
						<a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0" href="#" id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="bi bi-ui-radios-grid me-2"></i><span>Catégories</span></a>
				...
				<div class="nav my-3 my-xl-0 px-4 flex-nowrap align-items-center">
					<div class="nav-item w-100">
						<form class="position-relative">
							<input class="form-control pe-5 bg-transparent" type="search" placeholder="Recherche" aria-label="Search">
			...
			<div class="dropdown ms-1 ms-lg-0">
				...
				<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
					...
					<!-- Links -->
					<li><a class="dropdown-item" href="#"><i class="bi bi-person fa-fw me-2"></i>Modifier profils</a></li>
					<li><a class="dropdown-item" href="#"><i class="bi bi-gear fa-fw me-2"></i>Paramètre du compte</a></li>
	...
	<div class="container">
		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
				...
				<!-- Title -->
				<h1 class="mb-0 display-6">Des freelances illimité à portée 
					<span class="position-relative">de main
						<!-- SVG START -->
				...
				<ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
					<li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Validation des entreprises</li>
					<li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>Validation des freelances</li>
					<li class="list-inline-item"> <i class="bi bi-patch-check-fill h6 me-1"></i>Suivi des projets</li>
				</ul>
			</div>
			<!-- Left content END -->
			...
			<div class="col-lg-7 col-xl-6 text-center position-relative">
				...
				<div class="p-3 bg-blur border border-light shadow rounded-4 position-absolute bottom-0 start-0 z-index-9 d-none d-xl-block mb-5 ms-5">
					<div class="d-flex justify-content-between align-items-center">
						...
						<div class="text-start ms-3">
							<h6 class="mb-0 text-white">Félicitations <span class="ms-4"><i class="fas fa-check-circle text-success"></i></span></h6>
							<p class="mb-0 small text-white">Votre admission est terminée</p>
						</div>
					</div>
				</div>
				...
				<div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block" style="background:url(assets/images/pattern/01.png) no-repeat center center; background-size:cover;">
					<p class="text-white">Nos nouveaux freelances quotidiens</p>
					<!-- Avatar group -->
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 mx-auto text-center">
				<h2 class="fs-1">Les derniers projets </h2>
				<p class="mb-0">Choisi un des projets en fonction de ta spécialisation et communique avec nous</p>
			</div>
		</div>
		...
		<ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab" role="tablist">
			...
			<!-- Tab item -->
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-2" type="button" role="tab" aria-controls="course-pills-tabs-2"	aria-selected="false">Développeur</button>
			</li>
			<!-- Tab item -->
			<li class="nav-item me-2 me-sm-5">
				<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-3" data-bs-toggle="pill" data-bs-target="#course-pills-tabs-3" type="button" role="tab" aria-controls="course-pills-tabs-3" aria-selected="false">Design Graphic</button>
			</li>
			<!-- Tab item -->
			<li class="nav-item me-2 me-sm-5">
				...
				<div class="row g-4">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="assets/images/courses/08.jpg" class="card-img-top" alt="course image">
							<!-- Card body -->
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="assets/images/courses/02.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="assets/images/courses/03.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
					...
					<div class="col-sm-6 col-lg-4 col-xl-3">
						<div class="card shadow h-100">
							<!-- Image -->
							<img src="assets/images/courses/07.jpg" class="card-img-top" alt="course image">
							<div class="card-body pb-0">
								<!-- Badge and favorite -->
								<div class="d-flex justify-content-between mb-2">
									<a href="#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
					...
					<div class="row position-relative">
						...
						<div class="col-11 mx-auto position-relative">
							<div class="row align-items-center">
								<!-- Title -->
								<div class="col-lg-7">
									<h3 class="text-white">Devenez un de nos partenaires!</h3>
									<p class="text-white mb-3 mb-lg-0">Si vous avez des projets et que vous cherchez des freelances de qualité avec un suivi optimal. Contactez-nous et travaillons ensemble.</p>
								</div>
								<!-- Content and input -->
								<div class="col-lg-5 text-lg-end">
									<a href="#" class="btn btn-outline-warning mb-0">Contactez-nous</a>
								</div>
							</div>
						</div>
					</div> <!-- Row END -->
	...
	<div class="container">
		<div class="row g-4 g-lg-5 align-items-center">
				...
				<div class="row mt-0 mt-xl-5">
							...
							<blockquote>
								<p>
									<span class="me-1 small"><i class="fas fa-quote-left"></i></span>
										Super suivi de la plateformes. Entreprise en top. J'ai pu montée en compétences avec le projet que j'ai éffectué.
					...
					<div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
						<div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
							...
							<!-- Title -->
							<h6 class="mb-3">100+ Freelances vérifiés</h6>
							<!-- Mentor Item -->
							<div class="d-flex align-items-center mb-3">
								...
								<div class="ms-2">
									...
									<p class="mb-0 small">Développeur Web</p>
								</div>
							</div>
							...
							<div class="d-flex align-items-center mb-3">
								...
								<div class="ms-2">
									...
									<p class="mb-0 small">Marketing Digital</p>
								</div>
							</div>
							...
							<div class="d-flex align-items-center">
								...
								<div class="ms-2">
									...
									<p class="mb-0 small">Déeloppeur web</p>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-xl-5 order-1 text-center text-xl-start">
				<!-- Title -->
				<h2 class="fs-1">Quelques commentaires précieux de nos freelances</h2>
	...
	<div class="container">
		...
		<div class="row g-4">
			...
			<div class="col-lg-3">
				...
				<p class="my-3">AZERTY est une plateforme </p>
				<!-- Social media icon -->
			...
			<div class="col-lg-3">
				...
				<p class="mb-0">Email:<span class="h6 fw-light ms-2">azerty@gmail.com</span></p>
			</div> 
			<!-- Widget 3 END -->
		</div><!-- Row END -->
		...
		<div class="py-3">
			<div class="container px-0">
				<div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
					<!-- copyright text -->
					<div class="text-body text-primary-hover"> Copyrights ©2023 AZERTY.</div>
					<!-- copyright links-->
							...
							<li class="list-inline-item">
								...
								<div class="dropup mt-0 text-center text-sm-end">
									...
									<ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="assets/images/flags/uk.svg" alt="">Anglais</a></li>
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="assets/images/flags/gr.svg" alt="">Allemand </a></li>
										<li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2" src="assets/images/flags/sp.svg" alt="">Espagnol</a></li>
									</ul>
								</div>
							</li>
...
<script src="assets/vendor/glightbox.js"></script>
